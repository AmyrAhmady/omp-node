...
DECLARE_API_ARGNUM(Class, Add, 12, uint8_t team, int skin, float x, float y, float z, float angle, uint8_t weapon1, uint32_t ammo1, uint8_t weapon2, uint32_t ammo2, uint8_t weapon3, uint32_t ammo3, IntRef id)
{
...
DECLARE_API_ARGNUM(Class, GetData, 1, objectPtr classptr, UInt8Ref teamid, IntRef skin, FloatRef x, FloatRef y, FloatRef z, FloatRef angle, UInt8Ref weapon1, UInt32Ref weapon1_ammo, UInt8Ref weapon2, UInt32Ref weapon2_ammo, UInt8Ref weapon3, UInt32Ref weapon3_ammo)
{
