#define WRAP_POOL_EVENT_DISPATCHER_CUSTOM_STORAGE(PoolType, EntityType, StorageType) \
    ...
    StorageType* Wrap##EntityType##PoolEventDispatcher(EntityType##PoolEventDispatcher *dispatcher, \
    ...
    StorageType* Wrap##EntityType##PoolEventDispatcher(EntityType##PoolEventDispatcher *dispatcher, \
        ...
        return new StorageType(context->GetIsolate(), dispatcherHandle);\
    }

#define WRAP_POOL_EVENT_DISPATCHER(PoolType, EntityType) WRAP_POOL_EVENT_DISPATCHER_CUSTOM_STORAGE(PoolType, EntityType, PoolEventDispatcherHandleStorage)
