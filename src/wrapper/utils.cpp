...
v8::Local<v8::Object> PlayerKeyDataToJS(PlayerKeyData &data, v8::Local<v8::Context> context) {
    ...
    object->Set(context, v8::String::NewFromUtf8(isolate, "keys").ToLocalChecked(), v8::Integer::New(isolate, data.keys)).Check();
    object->Set(context, v8::String::NewFromUtf8(isolate, "upDown").ToLocalChecked(), v8::Integer::New(isolate, data.upDown)).Check();
    object->Set(context, v8::String::NewFromUtf8(isolate, "leftRight").ToLocalChecked(), v8::Integer::New(isolate, data.leftRight)).Check();
