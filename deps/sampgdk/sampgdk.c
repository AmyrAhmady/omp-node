...
SAMPGDK_NATIVE(bool, GetActorPos(int actorid, float * x, float * y, float * z)) {
  ...
  sampgdk_fakeamx_push_float(*x, &x_);
  sampgdk_fakeamx_push_float(*y, &y_);
  sampgdk_fakeamx_push_float(*z, &z_);
  params[0] = 4 * sizeof(cell);
  params[1] = (cell)actorid;
  params[2] = x_;
  params[3] = y_;
...
SAMPGDK_NATIVE(bool, GetActorFacingAngle(int actorid, float * angle)) {
  ...
  sampgdk_fakeamx_push_float(*angle, &angle_);
  params[0] = 2 * sizeof(cell);
  params[1] = (cell)actorid;
  params[2] = angle_;
  retval = native(sampgdk_fakeamx_amx(), params);
...
SAMPGDK_NATIVE(bool, GetActorHealth(int actorid, float * health)) {
  ...
  sampgdk_fakeamx_push_float(*health, &health_);
  params[0] = 2 * sizeof(cell);
  params[1] = (cell)actorid;
  params[2] = health_;
  retval = native(sampgdk_fakeamx_amx(), params);
...
SAMPGDK_NATIVE(bool, GetVehicleZAngle(int vehicleid, float * z_angle)) {
  ...
  sampgdk_fakeamx_push_float(*z_angle, &z_angle_);
  params[0] = 2 * sizeof(cell);
  params[1] = (cell)vehicleid;
  params[2] = z_angle_;
  retval = native(sampgdk_fakeamx_amx(), params);
...
SAMPGDK_NATIVE(bool, GetVehicleRotationQuat(int vehicleid, float * w, float * x, float * y, float * z)) {
  ...
  sampgdk_fakeamx_push_float(*w, &w_);
  sampgdk_fakeamx_push_float(*x, &x_);
  sampgdk_fakeamx_push_float(*y, &y_);
  sampgdk_fakeamx_push_float(*z, &z_);
  params[0] = 5 * sizeof(cell);
...
SAMPGDK_NATIVE(bool, GetVehicleParamsEx(int vehicleid, int * engine, int * lights, int * alarm, int * doors, int * bonnet, int * boot, int * objective)) {
  ...
  sampgdk_fakeamx_push_cell(*engine, &engine_);
  sampgdk_fakeamx_push_cell(*lights, &lights_);
  sampgdk_fakeamx_push_cell(*alarm, &alarm_);
  sampgdk_fakeamx_push_cell(*doors, &doors_);
  sampgdk_fakeamx_push_cell(*bonnet, &bonnet_);
  sampgdk_fakeamx_push_cell(*boot, &boot_);
  sampgdk_fakeamx_push_cell(*objective, &objective_);
  params[0] = 8 * sizeof(cell);
  params[1] = (cell)vehicleid;
  params[2] = engine_;
  params[3] = lights_;
...
SAMPGDK_NATIVE(bool, GetVehicleParamsCarDoors(int vehicleid, int * driver, int * passenger, int * backleft, int * backright)) {
  ...
  sampgdk_fakeamx_push_cell(*driver, &driver_);
  sampgdk_fakeamx_push_cell(*passenger, &passenger_);
  sampgdk_fakeamx_push_cell(*backleft, &backleft_);
  sampgdk_fakeamx_push_cell(*backright, &backright_);
  params[0] = 5 * sizeof(cell);
  params[1] = (cell)vehicleid;
  params[2] = driver_;
  params[3] = passenger_;
...
SAMPGDK_NATIVE(bool, GetVehicleDamageStatus(int vehicleid, int * panels, int * doors, int * lights, int * tires)) {
  ...
  sampgdk_fakeamx_push_cell(*panels, &panels_);
  sampgdk_fakeamx_push_cell(*doors, &doors_);
  sampgdk_fakeamx_push_cell(*lights, &lights_);
  sampgdk_fakeamx_push_cell(*tires, &tires_);
  params[0] = 5 * sizeof(cell);
  params[1] = (cell)vehicleid;
  params[2] = panels_;
  params[3] = doors_;
...
SAMPGDK_NATIVE(bool, SHA256_PassHash(const char * password, const char * salt, char * ret_hash, int ret_hash_len)) {
  ...
  sampgdk_fakeamx_push_string(ret_hash, NULL, &ret_hash_);
  params[0] = 4 * sizeof(cell);
  params[1] = password_;
  params[2] = salt_;
  params[3] = ret_hash_;
...
SAMPGDK_NATIVE(bool, GetSVarString(const char * varname, char * string_return, int len)) {
  ...
  sampgdk_fakeamx_push_string(varname, NULL, &varname_);
  sampgdk_fakeamx_push_string(string_return, NULL, &string_return_);
  params[0] = 3 * sizeof(cell);
  params[1] = varname_;
...
SAMPGDK_NATIVE(bool, GetSVarNameAtIndex(int index, char * ret_varname, int ret_len)) {
  ...
  sampgdk_fakeamx_push_string(ret_varname, NULL, &ret_varname_);
  params[0] = 3 * sizeof(cell);
  params[1] = (cell)index;
...
SAMPGDK_NATIVE(bool, GetPlayerNetworkStats(int playerid, char * retstr, int size)) {
  ...
  sampgdk_fakeamx_push_string(retstr, NULL, &retstr_);
  params[0] = 3 * sizeof(cell);
  params[1] = (cell)playerid;
  params[2] = retstr_;
  params[3] = (cell)size;
...
SAMPGDK_NATIVE(bool, GetPlayerVersion(int playerid, char * version, int len)) {
  ...
  sampgdk_fakeamx_push_string(version, NULL, &version_);
  params[0] = 3 * sizeof(cell);
  params[1] = (cell)playerid;
  params[2] = version_;
  params[3] = (cell)len;
...
SAMPGDK_NATIVE(bool, GetConsoleVarAsString(const char * varname, char * buffer, int len)) {
  ...
  sampgdk_fakeamx_push_string(varname, NULL, &varname_);
  sampgdk_fakeamx_push_string(buffer, NULL, &buffer_);
  params[0] = 3 * sizeof(cell);
  params[1] = varname_;
  params[2] = buffer_;
  params[3] = (cell)len;
...
SAMPGDK_NATIVE(bool, NetStats_GetIpPort(int playerid, char * ip_port, int ip_port_len)) {
  ...
  sampgdk_fakeamx_push_string(ip_port, NULL, &ip_port_);
  params[0] = 3 * sizeof(cell);
  params[1] = (cell)playerid;
  params[2] = ip_port_;
...
SAMPGDK_NATIVE(bool, FindModelFileNameFromCRC(int crc, char * model_str, int model_str_len)) {
  ...
  sampgdk_fakeamx_push_string(model_str, NULL, &model_str_);
  params[0] = 3 * sizeof(cell);
  params[1] = (cell)crc;
  params[2] = model_str_;
...
SAMPGDK_NATIVE(bool, FindTextureFileNameFromCRC(int crc, char * texture_str, int texture_str_len)) {
  ...
  sampgdk_fakeamx_push_string(texture_str, NULL, &texture_str_);
  params[0] = 3 * sizeof(cell);
  params[1] = (cell)crc;
...
SAMPGDK_NATIVE(bool, GetObjectRot(int objectid, float * rotX, float * rotY, float * rotZ)) {
  ...
  sampgdk_fakeamx_push_float(*rotX, &rotX_);
  sampgdk_fakeamx_push_float(*rotY, &rotY_);
  sampgdk_fakeamx_push_float(*rotZ, &rotZ_);
  params[0] = 4 * sizeof(cell);
  params[1] = (cell)objectid;
  params[2] = rotX_;
  params[3] = rotY_;
...
SAMPGDK_NATIVE(bool, GetPlayerArmour(int playerid, float * armour)) {
  ...
  sampgdk_fakeamx_push_float(*armour, &armour_);
  params[0] = 2 * sizeof(cell);
  params[1] = (cell)playerid;
  params[2] = armour_;
  retval = native(sampgdk_fakeamx_amx(), params);
...
SAMPGDK_NATIVE(bool, GetPlayerWeaponData(int playerid, int slot, int * weapon, int * ammo)) {
  ...
  sampgdk_fakeamx_push_cell(*weapon, &weapon_);
  sampgdk_fakeamx_push_cell(*ammo, &ammo_);
  params[0] = 4 * sizeof(cell);
  params[1] = (cell)playerid;
  params[2] = (cell)slot;
  params[3] = weapon_;
...
SAMPGDK_NATIVE(bool, GetPlayerIp(int playerid, char * ip, int size)) {
  ...
  sampgdk_fakeamx_push_string(ip, NULL, &ip_);
  params[0] = 3 * sizeof(cell);
  params[1] = (cell)playerid;
  params[2] = ip_;
  params[3] = (cell)size;
...
SAMPGDK_NATIVE(bool, GetPlayerKeys(int playerid, int * keys, int * updown, int * leftright)) {
  ...
  sampgdk_fakeamx_push_cell(*keys, &keys_);
  sampgdk_fakeamx_push_cell(*updown, &updown_);
  sampgdk_fakeamx_push_cell(*leftright, &leftright_);
  params[0] = 4 * sizeof(cell);
  params[1] = (cell)playerid;
  params[2] = keys_;
  params[3] = updown_;
...
SAMPGDK_NATIVE(bool, GetPlayerTime(int playerid, int * hour, int * minute)) {
  ...
  sampgdk_fakeamx_push_cell(*hour, &hour_);
  sampgdk_fakeamx_push_cell(*minute, &minute_);
  params[0] = 3 * sizeof(cell);
  params[1] = (cell)playerid;
  params[2] = hour_;
  params[3] = minute_;
...
SAMPGDK_NATIVE(bool, GetPlayerLastShotVectors(int playerid, float * fOriginX, float * fOriginY, float * fOriginZ, float * fHitPosX, float * fHitPosY, float * fHitPosZ)) {
  ...
  sampgdk_fakeamx_push_float(*fOriginX, &fOriginX_);
  sampgdk_fakeamx_push_float(*fOriginY, &fOriginY_);
  sampgdk_fakeamx_push_float(*fOriginZ, &fOriginZ_);
  sampgdk_fakeamx_push_float(*fHitPosX, &fHitPosX_);
  sampgdk_fakeamx_push_float(*fHitPosY, &fHitPosY_);
  sampgdk_fakeamx_push_float(*fHitPosZ, &fHitPosZ_);
  params[0] = 7 * sizeof(cell);
  params[1] = (cell)playerid;
  params[2] = fOriginX_;
  params[3] = fOriginY_;
